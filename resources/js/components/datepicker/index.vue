<template>
  ...
  >
    <div class="input-group input-group-alternative" @click="showPopup">
      ...
      <div class="input-group-append">
        <span v-if="showClearIcon" class="input-group-text" @click.stop="clearDate">
  ...
  computed: {
    ...
    showClearIcon() {
      return (
        !this.disabled &&
        this.clearable &&
        (this.range ? isValidRange(this.value) : isValidDate(this.value))
      );
    },
    innerType() {
  ...
  methods: {
    ...
    confirmDate() {
      const valid = this.range
        ? isValidRange(this.currentValue)
    ...
    handleValueChange(value) {
      if (!this.range) {
        ...
        this.currentValue = isValidRange(value)
